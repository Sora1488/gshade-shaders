...
dcl_output o0.xyzw
dcl_temps 3
add r0.xyzw, v1.xyxy, l(-0.015625, -0.000000, -0.014063, 0.000000)
...
add r1.xyzw, v1.xyxy, l(-0.012500, 0.000000, -0.010938, 0.000000)
...
add r1.xyzw, v1.xyxy, l(-0.009375, 0.000000, -0.007813, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t0.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(-0.006250, 0.000000, -0.004688, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t0.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(-0.003125, 0.000000, -0.001563, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t0.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(-0.000000, 0.000000, 0.001562, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t0.xyzw, s0
