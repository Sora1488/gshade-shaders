...
if_z cb0[0].x
  ...
  loop 
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r1.w, r2.xzxx, t6.yzwx, s0, l(0.000000)
...
if_nz r0.y
  ...
  loop 
    ...
    mad r0.x, r1.x, icb[r1.z + 0].w, r1.w
    iadd r1.z, r1.z, l(1)
  endloop 
endif 
if_nz r0.z
  ...
  loop 
    ...
    mad r0.x, r1.x, icb[r0.z + 4].y, r1.z
    iadd r0.z, r0.z, l(1)
  endloop 
endif 
if_nz r0.w
  ...
  loop 
    ige r0.w, r0.z, l(15)
    breakc_nz r0.w
    mul r0.w, cb0[0].y, icb[r0.z + 6].z
    mul r1.x, r0.w, l(0.000521)
    add r1.zw, r1.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r0.w, r1.zwzz, t6.yzwx, s0, l(0.000000)
    mad r0.w, r0.w, icb[r0.z + 6].w, r0.x
    add r1.xz, -r1.xxyx, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r1.x, r1.xzxx, t6.xyzw, s0, l(0.000000)
    mad r0.x, r1.x, icb[r0.z + 6].w, r0.w
    iadd r0.z, r0.z, l(1)
  endloop 
endif 
...
if_nz r0.y
  ...
  loop 
    ige r1.z, r0.w, l(18)
    breakc_nz r1.z
    mul r1.z, cb0[0].y, icb[r0.w + 15].x
    mul r1.x, r1.z, l(0.000521)
    add r1.zw, r1.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r1.z, r1.zwzz, t6.yzxw, s0, l(0.000000)
    ...
    add r1.xw, -r1.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r1.x, r1.xwxx, t6.xyzw, s0, l(0.000000)
    mad r0.z, r1.x, icb[r0.w + 15].y, r1.z
    iadd r0.w, r0.w, l(1)
  endloop 
  mov o0.x, r0.z
else 
