...
loop 
  ...
  if_nz r2.z
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r7.y, r5.xyxx, t2.xyzw, s0, l(0.000000)
    sample_l_indexable(texture2d)(float,float,float,float) r7.z, r6.zwzz, t2.xyzw, s0, l(0.000000)
    mul r5.xyz, r0.wwww, r7.xyzx
  else 
    sample_l_indexable(texture2d)(float,float,float,float) r5.xyz, r4.yzyy, t2.xyzw, s0, l(0.000000)
  endif 
