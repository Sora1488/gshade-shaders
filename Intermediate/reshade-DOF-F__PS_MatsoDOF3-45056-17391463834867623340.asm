...
mul r0.w, r0.y, l(0.000260)
div r0.w, r0.w, cb0[7].z
mul r1.x, r0.w, cb0[7].x
mul r1.xyzw, r1.xxxx, l(-1.000000, -1.000000, 0.584962, 0.584962)
exp r1.xyzw, r1.xyzw
...
loop 
  itof r4.x, r3.w
  ge r4.y, r4.x, cb0[7].z
  breakc_nz r4.y
  mul r4.yz, r2.xxyx, r4.xxxx
  mul r4.yz, r0.yyyy, r4.yyzy
  mul r4.yz, r4.yyzy, l(0.000000, 0.000260, 0.000463, 0.000000)
  div r4.yz, r4.yyzy, cb0[7].zzzz
  add r4.yz, r4.yyzy, v1.xxyx
  if_nz r2.z
    mad r5.xy, r4.yzyy, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
    mul r6.xyzw, r1.xyzw, r5.xyxy
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r7.y, r5.xyxx, t0.xyzw, s0, l(0.000000)
    sample_l_indexable(texture2d)(float,float,float,float) r7.z, r6.zwzz, t0.xyzw, s0, l(0.000000)
    mul r5.xyz, r0.wwww, r7.xyzx
  else 
    sample_l_indexable(texture2d)(float,float,float,float) r5.xyz, r4.yzyy, t0.xyzw, s0, l(0.000000)
  endif 
  dp3 r4.y, r5.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
  dp3 r4.z, r5.xyzx, r5.xyzx
  sqrt r4.z, r4.z
  add r4.y, r4.z, r4.y
  add r4.y, r4.y, l(0.100000)
  log r4.y, |r4.y|
  mul r4.y, r4.y, cb0[7].y
  exp r4.y, r4.y
  add r4.x, |r4.x|, r4.y
