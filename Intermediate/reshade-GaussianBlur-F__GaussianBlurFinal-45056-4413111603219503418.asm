...
loop 
  ...
  sample_l_indexable(texture2d)(float,float,float,float) r1.yzw, r1.yzyy, t4.wxyz, s0, l(0.000000)
  mad r2.xyz, r1.yzwy, icb[r0.w + 0].yyyy, r3.xyzx
  iadd r0.w, r0.w, l(1)
endloop 
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v1.xyxx, t0.xyzw, s0
add r1.xyz, -r0.xyzx, r2.xyzx
mad_sat o0.xyz, r1.xyzx, l(0.300000, 0.300000, 0.300000, 0.000000), r0.xyzx
ret 
