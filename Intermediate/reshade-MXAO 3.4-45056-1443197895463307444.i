...
#line 116
texture2D texColorBypass 	{ Width = 1920; 			  Height = 1080; 			    Format = RGBA8; MipLevels = 5+2;};
texture2D texDistance 		{ Width = 1920; 			  Height = 1080;  			    Format = R16F;  MipLevels = 5+0;};
texture2D texSurfaceNormal	{ Width = 1920;                           Height = 1080; 		            Format = RGBA8; MipLevels = 5+2;};
...
{
const float3 offs = float3(float2((1.0 / 1920), (1.0 / 1080)).xy,0);
#line 160
...
for(float y = -3; y <= 3; y++)
{
const float2 offsetcoord 	= texcoord.xy + float2(x,y) * float2((1.0 / 1920), (1.0 / 1080)).xy * 3.5;
...
{
blurcoord.xy 	= (2.0 * iStep - 0.5) * orientation * axis * float2((1.0 / 1920), (1.0 / 1080)).xy + texcoord.xy;
...
currentOffset = texcoord.xy + currentVector.xy * float2(1.0,(1920 * (1.0 / 1080))) * (iSample + radiusJitter);
#line 352
