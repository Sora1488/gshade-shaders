...
if_z cb0[0].x
  ...
  loop 
    ...
    mad r3.yz, -r3.xxyx, l(0.000000, 0.000000, 0.000926, 0.000000), v1.xxyx
...
if_nz r1.x
  ...
  loop 
    ...
    mad r1.xw, r3.xxxy, l(0.000000, 0.000000, 0.000000, 0.000926), v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r1.xwxx, t4.xyzw, s0, l(0.000000)
    mad r4.xyz, r4.xyzx, icb[r0.w + 0].wwww, r0.xyzx
    mad r1.xw, -r3.xxxy, l(0.000000, 0.000000, 0.000000, 0.000926), v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r3.yzw, r1.xwxx, t4.wxyz, s0, l(0.000000)
...
if_nz r1.y
  ...
  loop 
    ...
    mad r2.zw, r2.xxxy, l(0.000000, 0.000000, 0.000000, 0.000926), v1.xxxy
    ...
    mad r0.xyz, r2.yzwy, icb[r0.w + 4].yyyy, r3.xyzx
    iadd r0.w, r0.w, l(1)
  endloop 
endif 
if_nz r1.z
