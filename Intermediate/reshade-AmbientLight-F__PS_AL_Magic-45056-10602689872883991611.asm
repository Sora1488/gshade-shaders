...
mul r1.xyzw, r1.xyzw, l(1.150000, 1.150000, 1.150000, 1.150000)
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, v1.xyxx, t14.xyzw, s0
mad r1.xyzw, r1.xyzw, r1.xyzw, r1.xyzw
mad r1.xyzw, r1.xyzw, r3.xyzw, r1.xyzw
mul r2.y, r2.x, l(26.643749)
add r2.z, r0.y, r0.x
add r2.z, r0.z, r2.z
...
mad r2.x, -r2.x, l(35.524998), l(10.150000)
mov_sat r2.y, r2.x
add r1.xyzw, r1.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
