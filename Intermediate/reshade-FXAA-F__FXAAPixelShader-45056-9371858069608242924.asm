...
if_nz r2.w
  ...
  and r3.xy, r1.yyyy, l(0x3a088889, 0x3a4cccce, 0, 0)
  mad r4.xy, r2.zzzz, l(0.500000, 0.500000, 0.000000, 0.000000), v1.xyxx
  movc r1.w, r1.y, v1.x, r4.x
  movc r4.x, r1.y, r4.y, v1.y
  add r5.x, r3.w, r1.w
  movc r6.xyzw, r1.yyyy, l(-0.000000,-0.000781,0,-0.000000), l(-0.000926,-0.000000,0.001389,-0.001389)
  add r5.y, r4.x, r6.x
  add r7.x, r3.x, r1.w
  add r7.y, r3.z, r4.x
  ...
  if_nz r4.z
    ...
    movc r4.zw, r1.yyyy, l(0,0,0,-0.000000), l(0,0,0.001852,-0.001852)
    add r3.w, r4.w, r4.y
        ...
        if_nz r3.w
          ...
          if_nz r3.w
            ...
            if_nz r3.w
              ...
              ge r3.xy, |r2.ywyy|, r2.xxxx
              and r1.x, r1.y, l(0x3bccccce)
              movc r6.xyz, r1.yyyy, l(-0.006250,0,-0.000000,0), l(-0.000000,0.011111,-0.011111,0)
