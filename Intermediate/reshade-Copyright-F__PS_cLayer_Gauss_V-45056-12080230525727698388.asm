...
mul r0.xyzw, r0.xyzz, l(-0.777778, 0.437500, -0.587384, 0.040509)
...
switch cb0[4].z
  ...
  loop 
    ...
    mad r0.y, r1.y, icb[r1.z + 0].y, r1.w
    iadd r1.z, r1.z, l(1)
  endloop 
  break 
  case l(2)
  ...
  loop 
    ...
    add r2.xy, -r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r1.y, r2.xyxx, t6.xwyz, s0, l(0.000000)
    mad r0.y, r1.y, icb[r1.z + 0].w, r1.w
    iadd r1.z, r1.z, l(1)
  endloop 
  break 
  case l(3)
  ...
  loop 
    ...
    add r2.xy, -r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r1.y, r2.xyxx, t6.xwyz, s0, l(0.000000)
    mad r0.y, r1.y, icb[r1.z + 6].y, r1.w
    iadd r1.z, r1.z, l(1)
  endloop 
  break 
  default 
  ...
  loop 
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r1.z, r1.zwzz, t6.xywz, s0, l(0.000000)
    mad r1.z, r1.z, icb[r0.w + 11].w, r0.y
    add r1.yw, -r1.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r1.y, r1.ywyy, t6.xwyz, s0, l(0.000000)
    mad r0.y, r1.y, icb[r0.w + 11].w, r1.z
    iadd r0.w, r0.w, l(1)
  endloop 
  break 
endswitch 
