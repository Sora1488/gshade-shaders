...
if_nz r0.w
  ...
  switch cb0[8].x
    ...
    loop 
      ...
      loop 
        ...
        loop 
          ...
          mad r17.x, r17.x, cb0[10].x, l(1.000000)
          ...
          mul r17.xyz, r17.xyzx, cb0[12].zzzz
    ...
    add r6.z, -cb0[13].y, l(1.000000)
    add r6.w, cb0[13].y, l(1.000000)
    mov r4.xyz, r5.xyzx
    mov r7.zw, cb0[9].yyyw
    mov r8.x, cb0[10].w
    mov r8.yz, cb0[11].yywy
    mov r8.w, cb0[12].w
    mov r0.z, r2.w
    mov r9.x, l(1.000000)
    loop 
      ...
      loop 
        ...
        loop 
          ...
          mad r16.w, r16.w, cb0[10].x, l(1.000000)
          ...
          mad r17.xy, cb0[9].zzzz, r17.xyxx, r16.zwzz
          ...
          sqrt r16.z, r16.z
          log r16.z, r16.z
          mul r16.z, r16.z, cb0[12].x
          exp r16.z, r16.z
          add r16.z, r16.z, l(-1.000000)
          mad r16.z, cb0[12].y, r16.z, l(1.000000)
    ...
    loop 
      ...
      loop 
        ...
        loop 
          ...
          mad r16.x, r16.x, cb0[10].x, l(1.000000)
          ...
          mad r16.zw, cb0[9].zzzz, r16.zzzw, r16.xxxy
