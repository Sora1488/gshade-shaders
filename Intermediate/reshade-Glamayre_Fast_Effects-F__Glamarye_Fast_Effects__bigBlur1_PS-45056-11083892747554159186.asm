...
dcl_output o0.xyzw
dcl_temps 8
add r0.xyzw, v1.xyxy, l(-0.054688, -0.013889, -0.018229, -0.004630)
...
add r2.xyzw, v1.xyxy, l(0.018229, 0.004630, 0.054688, 0.013889)
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t4.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.zwzz, t4.xyzw, s2
