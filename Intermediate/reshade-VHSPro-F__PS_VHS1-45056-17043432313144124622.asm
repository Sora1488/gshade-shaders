...
movc r0.z, r0.z, l(1080.000000), r0.x
lt r1.x, r0.z, r0.y
or r0.w, r0.w, r1.x
...
if_nz cb0[8].y
  ...
  frc r1.w, r1.y
  add r2.zw, -r1.wwwy, l(0.000000, 0.000000, 1.000000, 3.141593)
  add r2.z, r2.z, r2.z
  ...
  round_ni r1.y, r1.y
  mad r2.zw, cb0[15].yyyy, l(0.000000, 0.000000, 0.000450, -0.000350), l(0.000000, 0.000000, 0.500000, 0.250000)
  frc r2.zw, r2.zzzw
  add r2.zw, -r2.zzzw, l(0.000000, 0.000000, 1.000000, 1.000000)
  mul r3.xy, r0.xxxx, r2.zwzz
  frc r3.xy, r3.xyxx
  mad r2.zw, r2.zzzw, r0.xxxx, -r3.xxxy
  div r1.w, r2.z, r1.y
  frc r1.w, |r1.w|
  mul r1.w, r1.y, r1.w
  lt r3.xy, r2.zwzz, l(0.000000, 0.000000, 0.000000, 0.000000)
  movc r1.w, r3.x, -r1.w, r1.w
  div r1.w, r1.w, r1.y
  add r3.x, -r1.w, l(1.000000)
  div r3.z, r0.x, r1.y
  mul r5.xy, r2.zwzz, r2.yyyy
  lt r5.x, r0.w, r5.x
  add r1.y, -r1.y, r2.z
  mul r1.y, r1.y, r2.y
  lt r1.y, r1.y, r0.w
  and r1.y, r1.y, r5.x
  mad r2.z, r0.w, r3.z, r3.x
  round_ni r2.z, r2.z
  div r2.z, r2.z, r3.z
  div r1.w, -r1.w, r3.z
  add r1.w, -r1.w, r2.z
  ...
  add r1.w, r1.w, r1.w
  add r2.z, -r1.y, l(3.141593)
  mul r3.x, r0.w, l(6.283185)
  mad r1.w, r3.x, r1.w, r2.z
...
mul r0.x, r0.y, l(1.777778)
mad r0.y, -r0.y, l(1.777778), l(1920.000000)
...
if_nz cb0[6].y
  ...
  loop 
    ...
    breakc_nz r2.y
    itof r2.y, r1.w
    mad r5.y, -r0.x, r2.y, r3.z
    sample_l_indexable(texture2d)(float,float,float,float) r2.z, r5.xyxx, t12.xzyw, s1, l(0.000000)
    lt r2.z, l(0.550000), r2.z
    mul r2.y, r2.y, l(0.157080)
    sincos r2.y, null, r2.y
    round_z r2.w, r2.y
    mul r2.w, r0.x, r2.w
    mad r6.x, -r2.w, l(4.000000), r0.w
    add r6.y, r0.y, r2.y
    movc r0.yw, r2.zzzz, r6.yyyx, r0.yyyw
    iadd r1.w, r1.w, l(1)
  endloop 
  mov r1.x, r0.w
else 
...
if_nz cb0[4].z
  mul r1.xyz, r3.yzyy, l(1920.000000, 1080.000000, 1920.000000, 0.000000)
  if_z cb0[4].w
...
if_nz cb0[6].y
  ...
  loop 
    ...
    breakc_nz r0.w
    itof r0.w, r1.y
    mad r3.x, -r0.x, r0.w, r3.y
    sample_l_indexable(texture2d)(float,float,float,float) r1.zw, r3.xzxx, t12.yzxw, s1, l(0.000000)
    ...
    if_nz r1.z
      ...
      mad r0.w, -r0.w, cb0[6].w, l(1.000000)
      mad r1.x, -r1.z, r0.w, l(1.000000)
    endif 
    iadd r1.y, r1.y, l(1)
  endloop 
  mov r6.x, r1.x
...
if_nz cb0[1].x
  mul r0.w, cb0[1].w, l(0.000521)
  mul r1.xyz, cb0[2].xyzx, l(0.000926, 0.000521, 0.000926, 0.000000)
  ge r1.w, r0.w, v1.x
  mad r2.x, -cb0[1].w, l(0.000521), l(1.000000)
  ge r2.y, v1.x, r2.x
  or r1.w, r1.w, r2.y
  ge r2.y, r1.x, v1.y
  or r1.w, r1.w, r2.y
  mad r2.y, -cb0[2].x, l(0.000926), l(1.000000)
  ge r2.z, v1.y, r2.y
  or r1.w, r1.w, r2.z
  lt r2.z, r0.w, v1.x
  mad r0.w, cb0[2].y, l(0.000521), r0.w
  lt r2.w, v1.x, r0.w
  and r2.z, r2.w, r2.z
  add r0.w, -r0.w, l(1.000000)
  lt r0.w, r0.w, v1.x
  ...
  mad r3.x, -cb0[1].w, l(0.000521), v1.x
  div r3.x, r3.x, r1.y
  add r2.x, r2.x, -v1.x
  div r1.y, r2.x, r1.y
  ...
  and r1.x, r1.y, r1.x
  or r0.w, r0.w, r1.x
  mad r1.x, -cb0[2].x, l(0.000926), v1.y
  add r1.y, r2.y, -v1.y
