...
if_nz r0.y
  ...
  loop 
    breakc_z r0.w
    add r2.xyz, r2.xyzx, l(0.000521, -0.000926, 1.000000, 0.000000)
  ...
  if_nz r0.w
    ...
    mad r2.xyzw, r1.yxzw, l(0.000521, 0.000926, 0.000521, 0.000926), v1.xyxy
  ...
  if_nz r1.z
    ...
    loop 
      breakc_z r2.y
      add r4.xyz, r4.xyzx, l(0.000521, 0.000926, 1.000000, 0.000000)
  ...
  if_nz r0.y
    mad r4.xyzw, r2.zzxx, l(-0.000521, -0.000926, 0.000521, 0.000926), v1.xyxy
  ...
  if_nz r0.y
    ...
    mad r2.z, r0.w, l(-0.000521), r3.x
    mad r1.zw, r2.zzzx, l(0.000000, 0.000000, 1920.000000, 1920.000000), -v1.zzzz
...
if_nz r0.x
  ...
  mad r1.zw, r0.zzzx, l(0.000000, 0.000000, 1080.000000, 1080.000000), -v1.wwww
  round_ne r1.zw, r1.zzzw
  sqrt r2.xy, |r1.wzww|
