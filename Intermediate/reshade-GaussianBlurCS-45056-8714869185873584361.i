...
texture PlaceHolder {Width = 1920; Height = 1080; Format = RGB10A2;};
texture Convolution {Width = 1920; Height = 1080; Format = RGB10A2;};
#line 57
...
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(1920, 1080));
...
int2 sampleCoord = sampleOffset + groupCoord;
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(1080, 1920));
...
DispatchSizeX = (int(1920 + 32 * 4 - 1) / int(32 * 4));
DispatchSizeY = (int(1080 + 2 - 1) / int(2));
}
pass
{
ComputeShader = VerticalPassCS<32, 2>;
DispatchSizeX = (int(1080 + 32 * 4 - 1) / int(32 * 4));
DispatchSizeY = (int(1920 + 2 - 1) / int(2));
}
pass
{
