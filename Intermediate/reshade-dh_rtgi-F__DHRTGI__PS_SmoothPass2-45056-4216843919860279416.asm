...
if_z r0.y
  ...
  if_z r0.y
        ...
        if_nz r9.w
          ...
          if_nz r9.w
            ...
            if_z r9.w
              ...
              ge r7.y, r0.w, r7.y
              if_nz r7.y
                sample_l_indexable(texture2d)(float,float,float,float) r7.y, r10.xyxx, t18.yxzw, s2, r2.w
                add r9.y, r7.y, r9.y
                iadd r9.z, r9.z, l(1)
              endif 
              sample_l_indexable(texture2d)(float,float,float,float) r10.xyz, r10.xyxx, t16.xyzw, s2, r2.w
    ...
    ige r0.x, l(1), r6.y
    if_nz r0.x
      sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, v1.xyxx, t16.xyzw, s2, r2.w
      sample_l_indexable(texture2d)(float,float,float,float) o1.xyzw, v1.xyxx, t18.xyzw, s2, r2.w
      mov r3.w, l(1.000000)
    else 
      itof r0.y, r6.w
