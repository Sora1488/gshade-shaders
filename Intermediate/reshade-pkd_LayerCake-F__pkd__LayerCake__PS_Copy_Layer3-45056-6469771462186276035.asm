...
//   bool CFG_LAYERCAKE_DEPTHENABLE_Layer3;// Offset:  132 Size:     4
//   float2 CFG_LAYERCAKE_DEPTH_Layer3; // Offset:  136 Size:     8
//   float CFG_LAYERCAKE_OPACITY_Layer3;// Offset:  144 Size:     4 [unused]
//   bool CFG_LAYERCAKE_MASKENABLE_Layer3;// Offset:  148 Size:     4
//   float3 CFG_LAYERCAKE_MASKCOLOR_Layer3;// Offset:  160 Size:    12
//   float CFG_LAYERCAKE_MASKBLEND_Layer3;// Offset:  172 Size:     4
//   bool CFG_LAYERCAKE_MASKINVERT_Layer3;// Offset:  176 Size:     4
//   bool CFG_LAYERCAKE_ALPHABLEND_Layer3;// Offset:  180 Size:     4
//   float2 CFG_LAYERCAKE_ALPHABLEND_DEPTH_Layer3;// Offset:  184 Size:     8
...
if_nz cb0[9].y
  ...
  lt r3.xyzw, l(0.040450, 0.040450, 0.040450, 0.040450), cb0[10].yzxy
  add r4.xyzw, cb0[10].yzxy, l(0.550000, 0.550000, 0.550000, 0.550000)
  mul r4.xyzw, r4.xyzw, l(0.947867, 0.947867, 0.947867, 0.947867)
  log r4.xyzw, |r4.xyzw|
  mul r4.xyzw, r4.xyzw, l(2.400000, 2.400000, 2.400000, 2.400000)
  exp r4.xyzw, r4.xyzw
  mul r5.xyzw, cb0[10].yzxy, l(0.077399, 0.077399, 0.077399, 0.077399)
  ...
  sqrt r0.z, r0.z
  div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[10].w
...
movc r0.z, cb0[11].y, r0.z, r0.w
movc r0.w, cb0[11].x, l(-1.000000), l(1.000000)
mul r0.z, r0.w, r0.z
movc r0.z, cb0[9].y, r0.z, l(1.000000)
add r0.w, -cb0[8].z, cb0[8].w
add r1.w, r0.y, -cb0[8].z
div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), r0.w
mul_sat r0.w, r0.w, r1.w
mad r1.w, r0.w, l(-2.000000), l(3.000000)
mul r0.w, r0.w, r0.w
mul r2.x, r0.w, r1.w
lt r2.y, cb0[11].w, r2.x
add r2.z, -cb0[11].w, l(1.000000)
...
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[11].z
mul_sat r1.w, r1.w, r2.x
mad r2.x, r1.w, l(-2.000000), l(3.000000)
mul r1.w, r1.w, r1.w
mul r1.w, r1.w, r2.x
movc r0.w, r2.y, r0.w, r1.w
movc r0.w, cb0[11].y, r0.w, l(1.000000)
mul r0.z, r0.w, r0.z
lt r0.w, r0.y, cb0[8].z
lt r0.y, cb0[8].w, r0.y
or r0.y, r0.y, r0.w
and r0.x, r0.y, r0.x
