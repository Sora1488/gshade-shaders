...
dcl_output o0.xyzw
dcl_temps 8
add r0.xyzw, v1.xyxy, l(0.013021, 0.023148, 0.039062, 0.069444)
...
add r3.xyzw, v1.xyxy, l(-0.039062, -0.069444, -0.013021, -0.023148)
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r3.zwzz, t8.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r3.xyxx, t8.xyzw, s0
