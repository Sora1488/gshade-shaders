...
if_nz r1.y
  ...
  if_nz r1.z
    ...
    loop 
      ...
      breakc_nz r2.w
      itof r2.w, r2.z
      mad r6.xy, r1.yzyy, r2.wwww, v1.xyxx
      ...
      movc r6.y, r2.y, r6.y, r6.z
      movc r6.x, r2.x, r6.x, r6.y
      ...
      mad r7.xyz, r7.xyzx, r7.wwww, r3.xyzx
      mad r3.w, r3.w, r4.w, r1.w
      mad r8.xy, -r1.yzyy, r2.wwww, v1.xyxx
      sample_l_indexable(texture2d)(float,float,float,float) r9.xyz, r8.xyxx, t0.xyzw, s0, l(0.000000)
      sample_l_indexable(texture2d)(float,float,float,float) r2.w, r8.xyxx, t10.yzwx, s0, l(0.000000)
      ...
      movc r8.x, r2.y, r8.x, r8.y
      movc r7.w, r2.x, r7.w, r8.x
      ...
      mad r3.xyz, r9.xyzx, r9.wwww, r7.xyzx
      mad r1.w, r2.w, r4.w, r3.w
      iadd r2.z, r2.z, l(1)
    endloop 
