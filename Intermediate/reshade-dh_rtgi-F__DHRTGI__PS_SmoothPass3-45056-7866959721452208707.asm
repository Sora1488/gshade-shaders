...
if_nz r0.y
  sample_l_indexable(texture2d)(float,float,float,float) o1.xyzw, v1.xyxx, t22.xyzw, s2, l(1.000000)
  mov r1.x, l(1.000000)
else 
  mov r1.x, l(0)
...
if_z r0.y
      ...
      if_nz r6.w
        ...
        if_nz r6.w
          ...
          if_z r6.w
            ...
            ge r4.y, l(17.000000), r4.y
            if_nz r4.y
              sample_l_indexable(texture2d)(float,float,float,float) r4.y, r6.yzyy, t22.yxzw, s2, l(1.000000)
              add r5.w, r4.y, r5.w
              iadd r6.x, r6.x, l(1)
            endif 
            sample_l_indexable(texture2d)(float,float,float,float) r6.yzw, r6.yzyy, t20.wxyz, s2, l(1.000000)
  ...
  ige r0.x, l(1), r3.x
  if_nz r0.x
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, v1.xyxx, t20.xyzw, s2, l(1.000000)
    sample_l_indexable(texture2d)(float,float,float,float) o1.xyzw, v1.xyxx, t22.xyzw, s2, l(1.000000)
    mov r4.w, l(1.000000)
  else 
    itof r0.y, r3.z
