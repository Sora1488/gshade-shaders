...
#line 161
texture texGravitySeedMap{ Width = 1920/1; Height = 768; Format = R16F; };
texture texGravitySeedMapCopy{ Width = 1920/1; Height = 768; Format = R16F; };
...
texture texGravityMain{ Width = 1920/1; Height = 768; Format = RGBA8; };
texture texGravityDepth{ Width = 1920/1; Height = 768; Format = R32F; };
#line 172
...
#line 295
finalist[y] = y;
depthlist[y] = depthlistU[y] = ReShade::GetLinearizedDepth(float2((id.x*1 + 0.5) / 1920, (y * 1080/768 + 0.5) / 1080));
}
...
#line 304
float4 rgbval =  tex2Dfetch(ReShade::BackBuffer, int2(id.x*1, yi*1080/768)); 
float scenedepth = depthlist[yi]; 
float strength = tex2Dfetch(SamplerGravitySeedMap, int2(id.x, yi)).r; 
strength = strength * GravityIntensity * inFocus(rgbval, scenedepth, float2((id.x*1 + 0.5) / 1920, (yi * 1080/768 + 0.5) / 1080)); 
...
{
if (y != finalist[y]) {
float4 storeVal = tex2Dfetch(ReShade::BackBuffer, int2(id.x, finalist[y] * 1080/768)); 
...
pass GravityMain { ComputeShader = gravityMain<1, 1>; DispatchSizeX = 1920/1; DispatchSizeY = 1; }
