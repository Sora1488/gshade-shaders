...
loop 
  ige r2.z, r1.w, l(4)
  breakc_nz r2.z
  mul r2.zw, r0.xxxx, icb[r1.w + 0].xxxy
  mad r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.000521, 0.000926), v1.xxxy
  sample_l_indexable(texture2d)(float,float,float,float) r3.x, r2.zwzz, t0.wxyz, s0, l(0.000000)
  ...
  add r2.z, -r0.z, r2.z
  dp3 r2.w, r3.yzwy, r1.xyzx
  add_sat r2.w, -r2.w, l(1.000000)
  add_sat r2.z, r0.w, -|r2.z|
...
if_nz r1.x
  ...
  if_nz r0.x
    add r0.xyzw, v1.zwzw, l(0.004167, 0.007407, -0.004167, 0.007407)
    ...
    add r0.x, r0.y, r0.x
    add r1.xyzw, v1.zwzw, l(0.004167, -0.007407, -0.004167, -0.007407)
