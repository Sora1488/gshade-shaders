...
if_z cb0[0].x
  ...
  loop 
    ...
    mad r0.xyz, r3.yzwy, r1.wwww, r4.xyzx
    iadd r0.w, r0.w, l(1)
  endloop 
endif 
if_nz r1.x
  ...
  loop 
    ige r1.x, r0.w, l(6)
    breakc_nz r1.x
    mul r3.y, l(0.000926), icb[r0.w + 0].x
    add r1.xw, r3.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r1.xwxx, t4.xyzw, s1, l(0.000000)
    mad r4.xyz, r4.xyzx, icb[r0.w + 0].yyyy, r0.xyzx
    add r1.xw, -r3.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r3.yzw, r1.xwxx, t4.wxyz, s1, l(0.000000)
...
if_nz r1.y
  ...
  loop 
    ige r2.z, r0.w, l(11)
    breakc_nz r2.z
    mul r2.y, l(0.000926), icb[r0.w + 0].z
    ...
    mad r0.xyz, r2.yzwy, icb[r0.w + 0].wwww, r3.xyzx
    iadd r0.w, r0.w, l(1)
  endloop 
endif 
if_nz r1.z
  ...
  loop 
    ige r1.w, r0.w, l(15)
    breakc_nz r1.w
    mul r2.y, l(0.000926), icb[r0.w + 6].x
    add r2.zw, r2.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.zwzz, t4.xyzw, s1, l(0.000000)
...
if_nz r0.w
  ...
  loop 
    ige r1.w, r0.w, l(18)
    breakc_nz r1.w
    mul r2.y, l(0.000926), icb[r0.w + 11].z
    add r2.zw, r2.xxxy, v1.xxxy
