...
loop 
  ...
  loop 
    ...
    mad r3.yz, r5.xxyx, l(0.000000, 0.004167, 0.007407, 0.000000), v1.xxyx
    sample_l_aoffimmi_indexable(3,0,0)(texture2d)(float,float,float,float) r3.w, r3.yzyy, t8.xzwy, s0, l(0.000000)
    sample_l_aoffimmi_indexable(0,0,0)(texture2d)(float,float,float,float) r5.xyzw, r3.yzyy, t22.xyzw, s0, l(0.000000)
    add r3.y, -r1.y, r3.w
...
add r2.xyzw, v1.xyxy, l(-0.002083, -0.003704, -0.002083, 0.000000)
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r1.zw, r2.xyxx, t8.zwxy, s0, l(0.000000)
add r3.xyzw, r0.yzyz, r2.xyzw
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r3.xy, r3.xyxx, t10.xyzw, s0, l(0.000000)
mov x0[0].xy, r1.zwzz
mul r4.yz, r3.xxyx, r3.xxyx
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r2.zw, r2.zwzz, t8.zwxy, s0, l(0.000000)
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r3.zw, r3.zwzz, t10.zwxy, s0, l(0.000000)
mov x0[1].xy, r2.zwzz
...
add r3.xyzw, v1.xyxy, l(-0.002083, 0.003704, 0.000000, -0.003704)
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r2.zw, r3.xyxx, t8.zwxy, s0, l(0.000000)
add r6.xyzw, r0.yzyz, r3.xyzw
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r3.xy, r6.xyxx, t10.xyzw, s0, l(0.000000)
mov x0[2].xy, r2.zwzz
...
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r2.zw, r3.zwzz, t8.zwxy, s0, l(0.000000)
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r3.xy, r6.zwzz, t10.xyzw, s0, l(0.000000)
mov x0[3].xy, r2.zwzz
...
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r2.zw, r2.zwzz, t10.zwxy, s0, l(0.000000)
mov x0[4].xy, r1.xyxx
...
add r5.xyzw, v1.xyxy, l(0.000000, 0.003704, 0.002083, -0.003704)
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r1.zw, r5.xyxx, t8.zwxy, s0, l(0.000000)
add r6.xyzw, r0.yzyz, r5.xyzw
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r2.zw, r6.xyxx, t10.zwxy, s0, l(0.000000)
mov x0[5].xy, r1.zwzz
...
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r1.zw, r5.zwzz, t8.zwxy, s0, l(0.000000)
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r2.zw, r6.zwzz, t10.zwxy, s0, l(0.000000)
mov x0[6].xy, r1.zwzz
mad r3.xy, r1.zwzz, r1.zwzz, r3.xyxx
mul r5.yz, r2.zzwz, r2.zzwz
mov r5.x, r2.z
add r4.xyz, r4.xyzx, r5.xyzx
mad r1.xy, r1.zwzz, r2.zwzz, r1.xyxx
add r5.xyzw, v1.xyxy, l(0.002083, 0.000000, 0.002083, 0.003704)
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r1.zw, r5.xyxx, t8.zwxy, s0, l(0.000000)
add r6.xyzw, r0.yzyz, r5.xyzw
sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r2.zw, r6.xyxx, t10.zwxy, s0, l(0.000000)
mov x0[7].xy, r1.zwzz
...
mov r6.w, r4.x
mov r1.zw, r0.yyyz
mov r2.zw, l(0,0,0.002083,0.003704)
mov r3.w, r0.w
mov r4.y, |r1.x|
mov r4.z, l(0)
mov r4.w, r1.y
loop 
  ...
  loop 
    ...
    loop 
      ...
      utof r13.x, r13.x
      utof r13.y, r14.x
      mad r13.xy, r13.xyxx, l(0.002083, 0.003704, 0.000000, 0.000000), r9.yzyy
      sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r13.xy, r13.xyxx, t10.xyzw, s0, l(0.000000)
