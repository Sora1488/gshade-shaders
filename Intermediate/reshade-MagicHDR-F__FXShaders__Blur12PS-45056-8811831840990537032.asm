...
dcl_output o0.xyzw
dcl_temps 3
add r0.xyzw, v1.xyxy, l(-0.800000, -0.000000, -0.666667, 0.000000)
...
add r1.xyzw, v1.xyxy, l(-0.533333, 0.000000, -0.400000, 0.000000)
...
add r1.xyzw, v1.xyxy, l(-0.266667, 0.000000, -0.133333, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t14.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(-0.000000, 0.000000, 0.133333, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t14.xyzw, s0
add r0.xyzw, r0.xyzw, r2.xyzw
mad r0.xyzw, r1.xyzw, l(0.857404, 0.857404, 0.857404, 0.857404), r0.xyzw
add r1.xyzw, v1.xyxy, l(0.266667, 0.000000, 0.400000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t14.xyzw, s0
mad r0.xyzw, r2.xyzw, l(0.540433, 0.540433, 0.540433, 0.540433), r0.xyzw
mad r0.xyzw, r1.xyzw, l(0.250420, 0.250420, 0.250420, 0.250420), r0.xyzw
add r1.xyzw, v1.xyxy, l(0.533333, 0.000000, 0.666667, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t14.xyzw, s0
mad r0.xyzw, r2.xyzw, l(0.085304, 0.085304, 0.085304, 0.085304), r0.xyzw
mad r0.xyzw, r1.xyzw, l(0.021362, 0.021362, 0.021362, 0.021362), r0.xyzw
add r1.xy, v1.xyxx, l(0.800000, 0.000000, 0.000000, 0.000000)
