...
dcl_output o0.xyzw
dcl_temps 4
add r0.xyzw, v1.xyxy, l(-0.008049, -0.003834, -0.006037, -0.002876)
...
add r1.xyzw, v1.xyxy, l(-0.004025, -0.001917, -0.002012, -0.000959)
...
add r1.xyzw, -r0.xyzw, r2.xyzw
mad r0.xyzw, r1.xyzw, l(0.200000, 0.200000, 0.200000, 0.200000), r0.xyzw
add r1.xyzw, v1.xyxy, l(0.002012, 0.000959, 0.004025, 0.001917)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t2.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t2.xyzw, s0
max r3.xyzw, r0.xyzw, r2.xyzw
mad r0.xyzw, r2.xyzw, l(0.111111, 0.111111, 0.111111, 0.111111), r0.xyzw
...
add r1.xyzw, -r0.xyzw, r2.xyzw
mad r0.xyzw, r1.xyzw, l(0.200000, 0.200000, 0.200000, 0.200000), r0.xyzw
add r1.xyzw, v1.xyxy, l(0.006037, 0.002876, 0.008049, 0.003834)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t2.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t2.xyzw, s0
max r3.xyzw, r0.xyzw, r2.xyzw
mad r0.xyzw, r2.xyzw, l(0.111111, 0.111111, 0.111111, 0.111111), r0.xyzw
