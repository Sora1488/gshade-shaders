...
add r3.yz, v1.xxyx, l(0.000000, 0.000000, -0.000926, 0.000000)
mov r3.x, r6.x
mov r1.xz, v1.yyxy
...
if_nz cb0[6].x
  ...
  loop 
    itof r1.x, r0.w
    ge r1.x, r1.x, cb0[6].w
    breakc_nz r1.x
    mov r3.xyzw, x0[r0.w + 0].xyzw
    mov r4.xyzw, x1[r0.w + 0].xyzw
    min r1.xz, r3.zzwz, r4.zzwz
    min r1.xz, r1.xxzx, r4.xxyx
    min r1.xz, r1.xxzx, r3.xxyx
    max r5.xy, r3.zwzz, r4.zwzz
    max r5.xy, r4.xyxx, r5.xyxx
    max r5.xy, r3.xyxx, r5.xyxx
    max r1.w, r5.y, r5.x
    min r1.x, r1.z, r1.x
    add r1.x, -r1.x, r1.w
    ...
    mov r4.xz, r3.yywy
    div r3.xyzw, r4.xyzw, r1.xxxx
    add r4.xyzw, -r1.zzzz, r5.xyzw
    add r3.xyzw, -r1.zzzz, r3.xyzw
