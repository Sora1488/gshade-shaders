...
loop 
  ...
  mad r2.xy, r1.wwww, l(0.001042, 0.000000, 0.000000, 0.000000), v1.xyxx
  sample_l_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t20.xyzw, s0, l(0.000000)
  mad r2.xyz, r2.xyzx, icb[r0.w + 0].yyyy, r1.xyzx
  mad r3.xy, -r1.wwww, l(0.001042, 0.000000, 0.000000, 0.000000), v1.xyxx
