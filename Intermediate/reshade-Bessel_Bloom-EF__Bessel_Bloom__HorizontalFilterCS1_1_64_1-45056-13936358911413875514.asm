...
switch cb0[1].z
  ...
  min r0.zw, r3.zzzw, l(0.000000, 0.000000, 1919.000000, 1079.000000)
  ftoi r4.xy, r0.zwzz
  mov r4.zw, l(0,0,0,0)
  ...
  min r2.zw, r2.zzzw, l(0.000000, 0.000000, 1919.000000, 1079.000000)
  ftoi r3.xy, r2.zwzz
  mov r3.zw, l(0,0,0,0)
  ...
  loop 
    ...
    min r2.yz, r2.yyzy, l(0.000000, 1919.000000, 1079.000000, 0.000000)
    ftoi r4.xy, r2.yzyy
    ld_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.xyzw, t2.xyzw
    mul r2.y, r5.w, l(3.000000)
    exp r2.y, -r2.y
    mul r5.xyz, r2.yyyy, r5.zxyz
    mov r5.w, x6[0].x
    mov r6.z, x6[0].y
    mov x6[0].xy, r5.ywyy
    mov r6.xy, r5.ywyy
    dp3 r2.y, r6.xyzx, r1.yzwy
    mov r2.zw, x7[0].xxxy
    dp2 r2.z, r2.zwzz, r0.zwzz
    add r6.x, r2.z, r2.y
    mov r6.y, x7[0].x
    mov x7[0].xy, r6.xyxx
    mov r7.y, x6[1].x
