...
loop 
  itof r3.w, r2.w
  lt r4.x, cb0[3].x, r3.w
  breakc_nz r4.x
  mul r4.x, r3.w, cb0[2].w
  ftoi r4.y, r4.x
  round_z r4.x, r4.x
  div r4.x, l(6.283000), r4.x
  div r4.z, r3.w, cb0[3].x
  add r4.z, r4.z, l(-1.000000)
  mad r4.z, cb0[3].w, r4.z, l(1.000000)
  mov r5.xyz, r3.xyzx
  mov r4.w, r1.w
  mov r5.w, l(0)
  loop 
    ...
    mul r6.xy, r6.xyxx, l(0.000521, 0.000926, 0.000000, 0.000000)
    div r6.xy, r6.xyxx, cb0[3].xxxx
    add r6.xy, r6.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r6.xyzw, r6.xyxx, t2.xyzw, s0, l(0.000000)
    dp3 r7.x, r6.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
    add r7.x, r7.x, -cb0[3].y
    mul r7.x, r7.x, cb0[3].z
    max r7.x, r7.x, l(0.000000)
    mad r7.x, r7.x, |r1.x|, l(1.000000)
    mul r6.xyz, r6.xyzx, r7.xxxx
    ge r7.x, r6.w, r1.z
    mad r6.w, r6.w, l(2.000000), l(-1.000000)
    mul r6.w, |r6.w|, |r6.w|
    mul r6.w, r6.w, r6.w
    movc r6.w, r7.x, l(1.000000), r6.w
    mul r7.x, r4.z, r6.w
    mad r5.xyz, r6.xyzx, r7.xxxx, r5.xyzx
    mad r4.w, r6.w, r4.z, r4.w
    iadd r5.w, r5.w, l(1)
  endloop 
  mov r3.xyz, r5.xyzx
  mov r1.w, r4.w
