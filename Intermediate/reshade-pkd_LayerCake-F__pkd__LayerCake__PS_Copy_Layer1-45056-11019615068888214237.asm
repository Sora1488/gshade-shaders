...
//   bool CFG_LAYERCAKE_DEPTHENABLE_Layer1;// Offset:    4 Size:     4
//   float2 CFG_LAYERCAKE_DEPTH_Layer1; // Offset:    8 Size:     8
//   float CFG_LAYERCAKE_OPACITY_Layer1;// Offset:   16 Size:     4 [unused]
//   bool CFG_LAYERCAKE_MASKENABLE_Layer1;// Offset:   20 Size:     4
//   float3 CFG_LAYERCAKE_MASKCOLOR_Layer1;// Offset:   32 Size:    12
//   float CFG_LAYERCAKE_MASKBLEND_Layer1;// Offset:   44 Size:     4
//   bool CFG_LAYERCAKE_MASKINVERT_Layer1;// Offset:   48 Size:     4
//   bool CFG_LAYERCAKE_ALPHABLEND_Layer1;// Offset:   52 Size:     4
//   float2 CFG_LAYERCAKE_ALPHABLEND_DEPTH_Layer1;// Offset:   56 Size:     8
...
if_nz cb0[1].y
  ...
  lt r3.xyzw, l(0.040450, 0.040450, 0.040450, 0.040450), cb0[2].yzxy
  add r4.xyzw, cb0[2].yzxy, l(0.550000, 0.550000, 0.550000, 0.550000)
  mul r4.xyzw, r4.xyzw, l(0.947867, 0.947867, 0.947867, 0.947867)
  log r4.xyzw, |r4.xyzw|
  mul r4.xyzw, r4.xyzw, l(2.400000, 2.400000, 2.400000, 2.400000)
  exp r4.xyzw, r4.xyzw
  mul r5.xyzw, cb0[2].yzxy, l(0.077399, 0.077399, 0.077399, 0.077399)
  ...
  sqrt r0.z, r0.z
  div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[2].w
...
movc r0.z, cb0[3].y, r0.z, r0.w
movc r0.w, cb0[3].x, l(-1.000000), l(1.000000)
mul r0.z, r0.w, r0.z
movc r0.z, cb0[1].y, r0.z, l(1.000000)
add r0.w, -cb0[0].z, cb0[0].w
add r1.w, r0.y, -cb0[0].z
div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), r0.w
mul_sat r0.w, r0.w, r1.w
mad r1.w, r0.w, l(-2.000000), l(3.000000)
mul r0.w, r0.w, r0.w
mul r2.x, r0.w, r1.w
lt r2.y, cb0[3].w, r2.x
add r2.z, -cb0[3].w, l(1.000000)
mad r0.w, r1.w, r0.w, -cb0[3].w
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), r2.z
mul_sat r0.w, r0.w, r1.w
mad r1.w, r0.w, l(-2.000000), l(3.000000)
mul r0.w, r0.w, r0.w
mad r0.w, -r1.w, r0.w, l(1.000000)
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[3].z
mul_sat r1.w, r1.w, r2.x
mad r2.x, r1.w, l(-2.000000), l(3.000000)
mul r1.w, r1.w, r1.w
mul r1.w, r1.w, r2.x
movc r0.w, r2.y, r0.w, r1.w
movc r0.w, cb0[3].y, r0.w, l(1.000000)
mul r0.z, r0.w, r0.z
lt r0.w, r0.y, cb0[0].z
