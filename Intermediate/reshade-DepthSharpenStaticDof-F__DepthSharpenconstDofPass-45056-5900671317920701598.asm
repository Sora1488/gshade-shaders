...
if_z cb0[0].z
  mad r3.xyzw, cb0[0].wwww, l(0.000174, 0.000309, -0.000174, -0.000309), v1.xyxy
...
if_nz r2.x
  mad r5.xyzw, cb0[0].wwww, l(0.000260, -0.000463, 0.000260, 0.000463), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r6.xyz, r5.xyxx, t0.xyzw, s0
  mad r7.xyzw, -cb0[0].wwww, l(0.000260, 0.000463, 0.000260, -0.000463), v1.xyxy
...
if_nz r2.y
  mad r5.xyzw, cb0[0].wwww, l(0.000208, -0.001111, 0.000625, 0.000370), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r2.xyw, r5.xyxx, t0.xywz, s0
  mad r6.xyzw, -cb0[0].wwww, l(0.000625, 0.000370, 0.000208, -0.001111), v1.xyxy
...
if_nz r2.z
  mov r2.xw, l(0.000260,0,0,-0.000463)
  mul r2.yz, cb0[0].wwww, l(0.000000, -0.000926, -0.000521, 0.000000)
  ...
  mul r5.xw, cb0[0].wwww, l(0.000521, 0.000000, 0.000000, 0.000926)
  mov r5.yz, l(0,0.000463,-0.000260,0)
