...
> = 1.0;
#line 112
texture texGaussianH { Width = 1920; Height = 1080; };
texture texGaussian { Width = 1920; Height = 1080; };
#line 116
...
float loops      = max( 1920, 1080 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 1920, 1080 ) / 1920.0f ); 
