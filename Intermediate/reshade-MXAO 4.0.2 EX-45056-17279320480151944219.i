...
{
const float2 sampleCoord = MXAO.texcoord.xy + blurOffsets[iStep] * float2((1.0 / 1920), (1.0 / 1080)) * radius / inputscale;
#line 303
...
{
const float2 searchRadiusScaled = 0.018 / P.z * float2(1.0,(1920 * (1.0 / 1080)));
...
{
const float4 cOffsets = float4(float2((1.0 / 1920), (1.0 / 1080)),-float2((1.0 / 1920), (1.0 / 1080))) * 8;
...
{
const float3 offs = float3(float2((1.0 / 1920), (1.0 / 1080)),0);
#line 406
...
{
sampleUV = MXAO.scaledcoord.xy + Dir.xy * float2(1.0, (1920 * (1.0 / 1080))) * (iSample + randStep);
