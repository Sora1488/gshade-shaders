...
if_z r0.y
  ...
  loop 
    ...
    breakc_nz r0.w
    itof r0.w, r0.y
    mad r1.z, r0.w, l(0.000521), v1.x
    lt r1.z, l(0.575000), r1.z
    mad r0.w, -r0.w, l(0.000521), v1.x
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r1.z, r1.zwzz, t10.yzxw, s1, l(0.000000)
    mov r1.w, x1[r0.y + 0].x
    mad r1.z, r1.z, r1.w, r0.z
    add r2.xy, -r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r0.w, r2.xyxx, t10.yzwx, s1, l(0.000000)
