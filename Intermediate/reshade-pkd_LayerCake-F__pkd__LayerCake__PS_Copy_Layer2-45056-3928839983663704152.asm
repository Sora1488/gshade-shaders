...
//   bool CFG_LAYERCAKE_DEPTHENABLE_Layer2;// Offset:   68 Size:     4
//   float2 CFG_LAYERCAKE_DEPTH_Layer2; // Offset:   72 Size:     8
//   float CFG_LAYERCAKE_OPACITY_Layer2;// Offset:   80 Size:     4 [unused]
//   bool CFG_LAYERCAKE_MASKENABLE_Layer2;// Offset:   84 Size:     4
//   float3 CFG_LAYERCAKE_MASKCOLOR_Layer2;// Offset:   96 Size:    12
//   float CFG_LAYERCAKE_MASKBLEND_Layer2;// Offset:  108 Size:     4
//   bool CFG_LAYERCAKE_MASKINVERT_Layer2;// Offset:  112 Size:     4
//   bool CFG_LAYERCAKE_ALPHABLEND_Layer2;// Offset:  116 Size:     4
//   float2 CFG_LAYERCAKE_ALPHABLEND_DEPTH_Layer2;// Offset:  120 Size:     8
...
if_nz cb0[5].y
  ...
  lt r3.xyzw, l(0.040450, 0.040450, 0.040450, 0.040450), cb0[6].yzxy
  add r4.xyzw, cb0[6].yzxy, l(0.550000, 0.550000, 0.550000, 0.550000)
  mul r4.xyzw, r4.xyzw, l(0.947867, 0.947867, 0.947867, 0.947867)
  log r4.xyzw, |r4.xyzw|
  mul r4.xyzw, r4.xyzw, l(2.400000, 2.400000, 2.400000, 2.400000)
  exp r4.xyzw, r4.xyzw
  mul r5.xyzw, cb0[6].yzxy, l(0.077399, 0.077399, 0.077399, 0.077399)
  ...
  sqrt r0.z, r0.z
  div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[6].w
...
movc r0.z, cb0[7].y, r0.z, r0.w
movc r0.w, cb0[7].x, l(-1.000000), l(1.000000)
mul r0.z, r0.w, r0.z
movc r0.z, cb0[5].y, r0.z, l(1.000000)
add r0.w, -cb0[4].z, cb0[4].w
add r1.w, r0.y, -cb0[4].z
div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), r0.w
mul_sat r0.w, r0.w, r1.w
mad r1.w, r0.w, l(-2.000000), l(3.000000)
mul r0.w, r0.w, r0.w
mul r2.x, r0.w, r1.w
lt r2.y, cb0[7].w, r2.x
add r2.z, -cb0[7].w, l(1.000000)
mad r0.w, r1.w, r0.w, -cb0[7].w
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), r2.z
mul_sat r0.w, r0.w, r1.w
mad r1.w, r0.w, l(-2.000000), l(3.000000)
mul r0.w, r0.w, r0.w
mad r0.w, -r1.w, r0.w, l(1.000000)
div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[7].z
mul_sat r1.w, r1.w, r2.x
mad r2.x, r1.w, l(-2.000000), l(3.000000)
mul r1.w, r1.w, r1.w
mul r1.w, r1.w, r2.x
movc r0.w, r2.y, r0.w, r1.w
movc r0.w, cb0[7].y, r0.w, l(1.000000)
mul r0.z, r0.w, r0.z
lt r0.w, r0.y, cb0[4].z
lt r0.y, cb0[4].w, r0.y
or r0.y, r0.y, r0.w
and r0.x, r0.y, r0.x
