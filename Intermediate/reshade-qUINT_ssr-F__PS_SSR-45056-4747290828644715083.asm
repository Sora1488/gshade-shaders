...
dcl_output o1.xyzw
dcl_temps 12
mad r0.xyzw, v1.xyxx, v3.xyzz, v2.xyzz
...
mul r0.xyzw, r0.xyzw, l(1000.000000, 1000.000000, 1000.000000, 1.000000)
...
mad r2.xyz, r2.xyzx, l(1000.000000, 1000.000000, 1000.000000, 0.000000), -r0.yzxy
...
mad r1.xyz, -r1.xyzx, l(1000.000000, 1000.000000, 1000.000000, 0.000000), r0.yzxy
...
mad r4.xyz, r4.xyzx, l(1000.000000, 1000.000000, 1000.000000, 0.000000), -r0.zxyz
...
div r4.xy, l(0.020833, 0.037037, 0.000000, 0.000000), r0.zzzz
mul r4.xy, r4.xyxx, l(0.350000, 0.350000, 0.000000, 0.000000)
mov r4.z, l(0)
add r5.xyzw, r4.xzzy, v1.xyxy
sample_l_indexable(texture2d)(float,float,float,float) r6.xyz, r5.xyxx, t0.xyzw, s0, l(0.000000)
dp3 r3.w, r6.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
mul r3.w, r3.w, l(0.000250)
...
dp3 r4.w, r7.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
mul r4.w, r4.w, l(0.000250)
...
mad r6.x, r4.z, l(0.000250), -r3.w
mad r6.y, r7.x, l(0.000250), -r4.w
...
mad r1.w, r2.w, l(0.012500), l(0.200000)
sqrt r0.w, r0.w
mul r0.w, r0.w, r1.w
...
loop 
  ...
  mad r3.w, r5.z, v3.z, v2.z
  sample_l_indexable(texture2d)(float,float,float,float) r4.w, r5.zwzz, t2.yzwx, s0, l(0.000000)
  mad r6.w, -r4.w, l(999.000000), l(1000.000000)
  div_sat r4.w, r4.w, r6.w
  mul r3.w, r3.w, r4.w
  mad r3.w, r3.w, l(1000.000000), -r8.z
  lt r4.w, r3.w, l(0.000000)
  mul r10.xyz, r7.xxxx, l(-2.500000, 0.625000, 0.050000, 0.000000)
  lt r3.w, r10.x, r3.w
  and r3.w, r3.w, r4.w
  ilt r4.w, r9.w, l(3)
  mad r10.xyw, -r4.xyxz, r10.yyyy, r8.xyxz
  mov r6.xy, r10.zwzz
  mov r7.y, r8.z
  movc r11.xyz, r4.wwww, r6.xyzx, r7.xyzx
  movc r6.xy, r4.wwww, r10.xyxx, r8.xyxx
  iadd r11.w, r9.w, l(1)
  movc r10.xy, r3.wwww, r6.xyxx, r8.xyxx
  mov r9.xy, r7.xyxx
  movc r9.xyzw, r3.wwww, r11.xyzw, r9.xyzw
  mov r10.z, r9.y
  mad r8.xyz, r4.xyzx, r9.xxxx, r10.xyzx
  mul r7.x, r9.x, l(1.600000)
  mad_sat r3.w, -r5.w, r5.w, r5.w
  ne r3.w, l(0.000000, 0.000000, 0.000000, 0.000000), r3.w
  movc r3.w, r3.w, l(0), l(20)
  iadd r3.w, r3.w, r9.z
  iadd r9.z, r3.w, l(1)
  ilt r2.w, r3.w, l(20)
endloop 
