...
if_nz r1.y
  ...
  if_nz r1.y
    ...
    mul r1.xz, r1.xxxx, l(0.000521, 0.000000, 0.000000, 0.000000)
    div r1.xz, r1.xxzx, l(0.500000, 0.000000, 0.500000, 0.000000)
    mov r3.xyz, r2.xyzx
    mov r4.xyz, r0.xyzx
    mov r1.w, r1.y
    mov r4.w, r1.y
    ...
    loop 
      ...
      sample_l_indexable(texture2d)(float,float,float,float) r8.xyz, r5.yzyy, t0.xyzw, s0, l(0.000000)
