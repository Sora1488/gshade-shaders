...
div r2.xyz, l(0.000005, 0.000009, 0.000200, 0.000000), r0.xxxx
...
mad r0.yzw, r2.xxyz, l(0.000000, 0.300000, 0.300000, 0.300000), r0.yyzw
dp3 r1.w, r0.yzwy, r0.yzwy
rsq r1.w, r1.w
mul r0.yzw, r0.yyzw, r1.wwww
...
mul r3.xy, r0.yzyy, l(0.000521, 0.000926, 0.000000, 0.000000)
mov r4.xyz, l(0,0,0,0)
mov r1.w, l(1.000000)
loop 
  lt r2.w, l(32.000000), r1.w
  breakc_nz r2.w
  mul r3.zw, r1.wwww, r3.xxxy
  mad r3.zw, r3.zzzw, l(0.000000, 0.000000, 3.125000, 3.125000), v1.xxxy
  sample_l_indexable(texture2d)(float,float,float,float) r5.xyz, r3.zwzz, t0.xyzw, s0, l(0.000000)
  sample_l_indexable(texture2d)(float,float,float,float) r2.w, r3.zwzz, t2.yzwx, s0, l(0.000000)
  mad r3.z, -r2.w, l(999.000000), l(1000.000000)
  div r2.w, r2.w, r3.z
  add r2.w, r0.x, -r2.w
  add r2.w, r2.w, l(-0.005000)
  mul_sat r2.w, r2.w, l(-200.000000)
  mad r3.z, r2.w, l(-2.000000), l(3.000000)
  mul r2.w, r2.w, r2.w
  mul r2.w, r2.w, r3.z
  dp3 r3.z, r5.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
  add r3.z, r3.z, l(-0.100000)
  mul_sat r3.z, r3.z, l(9.999001)
...
mad_sat r0.x, r0.x, l(0.300000), r0.z
...
movc r1.xyzw, r0.yyyy, r1.xyzw, r3.xyzw
lt r0.y, r2.x, r1.x
mov r3.z, r2.x
mov r3.xyw, r1.xwxz
movc r0.yzw, r0.yyyy, r3.xxyz, r3.zzwx
min r1.x, r1.y, r0.w
add r1.x, r0.y, -r1.x
add r0.w, -r1.y, r0.w
...
add r3.xyzw, -|r0.zzzz|, l(0.083333, 0.166667, 0.333333, 0.500000)
mul r3.xyzw, r3.xyzw, l(-12.000001, -6.000000, 6.000000, 6.000000)
...
mul r0.x, r0.y, r0.x
mad r0.yzw, r4.xxyz, l(0.000000, 0.031250, 0.031250, 0.031250), -r2.xxyz
