...
static const float2 dither_uv = float2( 1920, 1080 ) / 512.0f;
#line 69
...
> = 6500;
#line 213
texture texPrepLOD { Width = 1920; Height = 1080; MipLevels = 5; };
...
#line 234
texture texBloomIn { Width = ( 1920 / 2 ); Height = ( 1080 / 2 ); Format = RGBA16F; };
texture texBloomH { Width = ( 1920 / 2 ); Height = ( 1080 / 2 ); Format = RGBA16F; };
texture texBloom { Width = ( 1920 / 2 ); Height = ( 1080 / 2 ); Format = RGBA16F; };
texture texBloomAll { Width = ( 1920 / 2 ); Height = ( 1080 / 2 ); Format = RGBA16F; };
#line 256
