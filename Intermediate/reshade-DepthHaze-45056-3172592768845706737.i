...
for(float i = 1; i < 5; ++i)
{
float2 sourceCoords = texcoord + float2(i * float2((1.0 / 1920), (1.0 / 1080)).x, 0.0);
...
n+=weight;
#line 71
sourceCoords = texcoord - float2(i * float2((1.0 / 1920), (1.0 / 1080)).x, 0.0);
...
for(float j = 1; j < 5; ++j)
{
float2 sourceCoords = texcoord + float2(0.0, j * float2((1.0 / 1920), (1.0 / 1080)).y);
...
n+=weight;
#line 93
sourceCoords = texcoord - float2(0.0, j * float2((1.0 / 1920), (1.0 / 1080)).y);
