...
mad r0.w, r0.w, l(-3.000000), l(4.000000)
round_ne r0.w, r0.w
...
mov x0[6].xy, r0.ywyy
mov x0[7].xy, r4.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r2.xzw, v1.xyxx, t18.xwyz, s0, l(0.000000)
mov r3.xyz, r2.xzwx
mov r0.yw, l(0,1,0,0)
loop 
  ilt r3.w, l(7), r0.w
  ...
  lt r4.z, r4.z, r2.y
  and r3.w, r3.w, r4.z
  sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t18.xyzw, s0, l(0.000000)
