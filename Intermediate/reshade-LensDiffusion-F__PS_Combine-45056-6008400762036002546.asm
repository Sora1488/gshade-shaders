...
sample_indexable(texture2d)(float,float,float,float) r3.xyz, v1.xyxx, t12.xyzw, s1
mul r4.xyz, r3.xyzx, l(0.752500, 0.670000, 1.000000, 0.000000)
dp3 r1.w, r4.xyzx, l(0.212395, 0.701049, 0.086556, 0.000000)
mad r4.xyz, r3.xyzx, l(0.752500, 0.670000, 1.000000, 0.000000), -r1.wwww
dp3 r1.w, r3.xyzx, l(0.212395, 0.701049, 0.086556, 0.000000)
add r3.xyz, r1.wwww, r4.xyzx
add r3.xyz, -r2.xyzx, r3.xyzx
mul r3.xyz, r0.wwww, r3.xyzx
mad r2.xyz, r3.xyzx, l(0.750000, 0.750000, 0.750000, 0.000000), r2.xyzx
