...
return ori;
#line 116
const float depthTL = ReShade::GetLinearizedDepth( tex + float2(-float2((1.0 / 1920), (1.0 / 1080)).x, -float2((1.0 / 1920), (1.0 / 1080)).y) ).r;
const float depthTR = ReShade::GetLinearizedDepth( tex + float2(float2((1.0 / 1920), (1.0 / 1080)).x, -float2((1.0 / 1920), (1.0 / 1080)).y) ).r;
