...
mul r2.xy, |r0.zzzz|, l(26.500002, 0.082596, 0.000000, 0.000000)
...
if_nz r0.w
  ...
  mad r0.z, r0.z, l(0.603774), l(1.000000)
  round_ne r0.z, r0.z
  mul r2.xyz, |r2.xyzx|, |r2.xyzx|
  mul r2.xyz, r2.xyzx, r2.xyzx
  mov x0[0].y, l(0)
  mov x0[0].x, l(1.000000)
  mov x0[1].y, l(0.500000)
  mov x0[1].x, l(0.866025)
  mov x0[2].y, l(0.866025)
  mov x0[2].x, l(0.500000)
  mov x0[3].y, l(1.000000)
  mov x0[3].x, l(0.000000)
  mov x0[4].y, l(0.866026)
  mov x0[4].x, l(-0.500000)
  mov x0[5].y, l(0.500000)
  mov x0[5].x, l(-0.866025)
  mov x0[6].y, l(0.000000)
  mov x0[6].x, l(-1.000000)
  mov x0[7].y, l(-0.500000)
  mov x0[7].x, l(-0.866026)
  mov x0[8].y, l(-0.866025)
  mov x0[8].x, l(-0.500000)
  mov x0[9].y, l(-1.000000)
  mov x0[9].x, l(-0.000000)
  mov x0[10].y, l(-0.866026)
  mov x0[10].x, l(0.499999)
  mov x0[11].y, l(-0.500001)
  mov x0[11].x, l(0.866025)
  mov x0[12].y, l(-0.000000)
  mov x0[12].x, l(1.000000)
