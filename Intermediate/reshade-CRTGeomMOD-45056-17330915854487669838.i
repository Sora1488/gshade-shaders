...
> = float3(0.0, 0.0, 0.0);
#line 430
texture background_texture <source="background.png";> { Width = 1920; Height = 1080; Format = RGBA8; };
...
#line 439
texture frame_texture <source="frame.png";> { Width = 1920; Height = 1080; Format = RGBA8; };
sampler frame_sampler { Texture = frame_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 442
texture overlay_texture <source="overlay.png";> { Width = 1920; Height = 1080; Format = RGBA8; };
sampler overlay_sampler { Texture = overlay_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 445
texture mask_texture <source="mask.png";> { Width = 1920 / 2; Height = 1920 / 2; Format = RGBA8; };
...
#line 449
texture mask2x2_texture <source="mask2x2.png";> { Width = 1920 / 2; Height = 1920 / 2; Format = RGBA8; };
...
#line 456
texture BloomBlurTex { Width = 1920 / 2; Height = 1080 / 2; Format = RGBA8; };
sampler BloomBlurSampler { Texture = BloomBlurTex; };
#line 459
texture BloomBlurTex2 { Width = 1920 / 2; Height = 1080 / 2; Format = RGBA8; };
