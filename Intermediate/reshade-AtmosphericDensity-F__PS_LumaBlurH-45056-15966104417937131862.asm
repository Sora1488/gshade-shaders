...
if_nz r0.y
  ...
  if_z r0.z
    ...
    loop 
      ...
      sample_l_indexable(texture2d)(float,float,float,float) r1.w, r2.xyxx, t10.yzwx, s1, l(0.000000)
      mov r2.x, x1[r0.z + 0].x
      mad r1.w, r1.w, r2.x, r0.w
      add r1.xz, -r1.xxyx, v1.xxyx
      sample_l_indexable(texture2d)(float,float,float,float) r1.x, r1.xzxx, t10.xyzw, s1, l(0.000000)
      mad r0.w, r1.x, r2.x, r1.w
      iadd r0.z, r0.z, l(1)
    endloop 
  endif 
  mov o0.xyz, r0.wwww
