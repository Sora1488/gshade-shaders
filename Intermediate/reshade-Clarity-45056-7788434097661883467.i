...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(ClaritySampler3, float4(texcoord + float2(0.0, offset[i] * float2((1.0 / 1920), (1.0 / 1080)).y) * ClarityOffset, 0.0, 0.0)).r * weight[i];
color += tex2Dlod(ClaritySampler3, float4(texcoord - float2(0.0, offset[i] * float2((1.0 / 1920), (1.0 / 1080)).y) * ClarityOffset, 0.0, 0.0)).r * weight[i];
}
}
#line 107
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(ReShade::BackBuffer, float4(texcoord + float2(offset[i] * float2((1.0 / 1920), (1.0 / 1080)).x, 0.0) * ClarityOffset, 0.0, 0.0)).rgb * weight[i];
color += tex2Dlod(ReShade::BackBuffer, float4(texcoord - float2(offset[i] * float2((1.0 / 1920), (1.0 / 1080)).x, 0.0) * ClarityOffset, 0.0, 0.0)).rgb * weight[i];
}
}
#line 283
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(ClaritySampler, float4(texcoord + float2(0.0, offset[i] * float2((1.0 / 1920), (1.0 / 1080)).y) * ClarityOffset, 0.0, 0.0)).r* weight[i];
color += tex2Dlod(ClaritySampler, float4(texcoord - float2(0.0, offset[i] * float2((1.0 / 1920), (1.0 / 1080)).y) * ClarityOffset, 0.0, 0.0)).r* weight[i];
}
}
#line 365
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(ClaritySampler2, float4(texcoord + float2(offset[i] * float2((1.0 / 1920), (1.0 / 1080)).x, 0.0) * ClarityOffset, 0.0, 0.0)).r* weight[i];
color += tex2Dlod(ClaritySampler2, float4(texcoord - float2(offset[i] * float2((1.0 / 1920), (1.0 / 1080)).x, 0.0) * ClarityOffset, 0.0, 0.0)).r* weight[i];
}
}
#line 447
