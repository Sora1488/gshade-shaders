...
dcl_output o0.xyzw
dcl_temps 10
add r0.xyzw, v1.xyxy, l(0.000000, 0.000000, 0.000000, 0.118519)
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.xyxx, t2.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.zwzz, t2.xyzw, s0
add r2.xyzw, v1.xyxy, l(0.000000, -0.237037, 0.000000, -0.118518)
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.zwzz, t2.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t2.xyzw, s0
add r4.xyzw, v1.xyxy, l(0.000000, -0.474074, 0.000000, -0.355556)
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.zwzz, t2.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t2.xyzw, s0
add r6.xyzw, v1.xyxy, l(-0.000000, -0.711111, 0.000000, -0.592593)
sample_indexable(texture2d)(float,float,float,float) r7.xyzw, r6.xyxx, t2.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r6.zwzz, t2.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(0.000000, 0.237037, 0.000000, 0.355556)
...
add r1.xyzw, v1.xyxy, l(0.000000, 0.474074, 0.000000, 0.592593)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t2.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t2.xyzw, s0
mad r0.xyzw, r2.xyzw, r9.zzzz, r0.xyzw
mad r0.xyzw, r1.xyzw, r9.yyyy, r0.xyzw
add r1.xy, v1.xyxx, l(0.000000, 0.711111, 0.000000, 0.000000)
