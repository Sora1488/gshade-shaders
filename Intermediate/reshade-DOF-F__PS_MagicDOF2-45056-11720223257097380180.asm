...
loop 
  ...
  div r2.yz, r2.yyzy, cb0[4].yyyy
  add r2.yz, r2.yyzy, v1.xxyx
  sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r2.yzyy, t2.xyzw, s0, l(0.000000)
  mov r3.z, -r3.x
  mul r2.yz, r1.xxxx, r3.zzyz
  mul r2.yz, r2.yyzy, l(0.000000, 0.000521, 0.000926, 0.000000)
  div r2.yz, r2.yyzy, cb0[4].yyyy
  add r2.yz, r2.yyzy, v1.xxyx
  ...
  iadd r2.x, r2.x, l(1)
endloop 
div_sat r1.yzw, r1.yyzw, r2.wwww
